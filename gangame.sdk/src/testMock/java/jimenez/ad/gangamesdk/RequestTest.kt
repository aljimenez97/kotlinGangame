...
class RequestTest {
    ...
    fun topRatedRequest_success(){
        ...
        games?.let {
            ...
            games.zip(jsonResponse).forEach{(deal, jsonTopGame) ->
                with(jsonTopGame.asJsonObject){
                    ...
                    Assert.assertEquals(deal.thumb, "http://cdn.akamai.steamstatic.com/steam/apps/${this["appid"]}/capsule_184x69.jpg")
